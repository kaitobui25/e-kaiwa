...
def _client_settings_payload(runtime: Runtime) -> dict:
    ...
    return {
        ...
        "settings": {
            ...
            "live_idle_timeout_seconds": settings["live_idle_timeout_seconds"],
    ...
    class LiveRequestHandler(BaseHTTPRequestHandler):
        ...
        def do_GET(self) -> None:
            ...
            static_routes = {
                ...
                "/live/main.js": (WEB_DIR / "live/main.js", "text/javascript; charset=utf-8"),
                ...
                "/shared/preferences.js": (WEB_DIR / "shared/preferences.js", "text/javascript; charset=utf-8"),
                "/shared/replay_policy.js": (WEB_DIR / "shared/replay_policy.js", "text/javascript; charset=utf-8"),
            }
